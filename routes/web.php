...
Route::middleware('splade')->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        //vat
        Route::get('/vattu', [vatTuController::class, 'index'])->middleware(['verified'])->name('vatTu');
        Route::get('/vattu/create', [vatTuController::class, 'create'])->middleware(['verified'])->name('vatTu.create');
        Route::post('/vattu/create', [vatTuController::class, 'store'])->middleware(['verified'])->name('vatTu.store');
        Route::get('/vattu/{vatTu}/edit', [vatTuController::class, 'edit'])->middleware(['verified'])->name('vatTu.edit');
        Route::patch('/vattu/{vatTu}/edit', [vatTuController::class, 'update'])->middleware(['verified'])->name('vatTu.update');
        Route::delete('/vattu/{vatTu}', [vatTuController::class, 'destroy'])->name('vatTu.destroy');


        //import
        Route::get('/import', [importController::class, 'index'])->middleware(['verified'])->name('import');
        Route::get('/import/create', [importController::class, 'create'])->middleware(['verified'])->name('import.create');
        Route::post('/import/create', [importController::class, 'store'])->middleware(['verified'])->name('import.store');
